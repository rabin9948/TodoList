...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#myPage"><strong>${userInfo.uid}</strong>의 TO do list</a>
			
				<a class="navbar-brand" href="/logOut"><h5>로그아웃</h5></a>
	...
	<div class="container-fluid bg-grey" id="profile">
		<div class="row">
			<div class="col-sm-4">
				<img src="/resources/img/backgrounds/4809.jpg" style="margin:25% 0 0 30%" class="glyphicon glyphicon-globe logo"></img>
			</div>
			<div class="col-sm-8">
				<h2>Profile</h2>
				<br>
	...
	<div id="services" class="container-fluid text-center" style="height: auto; width: 100%;" >
	 <div>
	 	<h2 class="newGroup newH2">SERVICES</h2><form action="/newBoard" method="get"><button class="btn btn-primary newButton newGroup">New Board</button></form>
	 </div>
		<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="boardVO">
							...
							<tr>
								...
								<td class="col-sm-7"> <a href="/readPage?bno=${boardVO.bno }&page=${pageMaker.cri.page}"><Strong>${boardVO.title}</Strong></a></td>
								<td class="col-sm-2 text-center">${boardVO.writer}</td>
								<td class="col-sm-2 text-center"><fmt:formatDate pattern="yyyy-MM-dd HH:mm"
										value="${boardVO.regdate}" />${boardVO.regdate}</td>
								<tr>
...
google.maps.event.addDomListener(window, 'load', initialize);
	...
	<p>
		Bootstrap Theme Made By <a href="http://www.w3schools.com"
